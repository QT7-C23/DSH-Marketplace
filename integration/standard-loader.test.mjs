...
import apply, { standardRuntimeState, STANDARD_LOADER_URL, standardLoaderConfig } from './plugin/compatibility/standard-loader.mjs';
import { standardControl } from './plugin/compatibility/standard-control.mjs';
