...
| 30 OpenAI curated Skills | [openai/skills](https://github.com/openai/skills/tree/49f948faa9258a0c61caceaf225e179651397431/skills/.curated), commit `49f948faa9258a0c61caceaf225e179651397431`; original publishers and attribution retained | The catalog records the exact directory and file hashes. Reviewed original license texts: [Apache standard](licenses/sources/openai-apache-2.0-standard.txt), [Apache ChatGPT](licenses/sources/openai-apache-2.0-chatgpt.txt), [Apache OpenAI](licenses/sources/openai-apache-2.0.txt), [Apache Playwright](licenses/sources/openai-apache-2.0-playwright.txt), [MIT Notion Labs](licenses/sources/openai-mit-notion.txt), [MIT Vercel](licenses/sources/openai-mit-vercel.txt). Archives retain their original files and license. Custom-license directories are excluded. |
| npm directory metadata | Packages discovered under `dsh-plugin`, `dsh-theme`, and `dsh-std` keywords in the [npm registry](https://registry.npmjs.org/) | Package names, descriptions, versions, publisher links and declared licenses remain publisher metadata. Discovery does not verify compatibility or relicense package contents. Inspect the exact package and its notices before installation. |
...
| Development screenshot | [assets/marketplace.png](assets/marketplace.png), captured from our isolated DSH development host | Shows the project UI, upstream DeepSeek Harness UI and branding, and attributed resource metadata. No affiliation or trademark permission is implied. |
