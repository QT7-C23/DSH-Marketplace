...
import { profilePackages, nativeRuntimePort, standardRuntimePort } from '../../src/plugin/compatibility/ports.mjs';
...
test('management imports keep UI, package inspection, state projection and process execution separate', async () => {
  const read = file => readFile(path.resolve('src/plugin', file), 'utf8');
