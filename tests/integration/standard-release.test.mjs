...
import { standardLoaderConfig, STANDARD_LOADER_EXPORT } from '../../src/plugin/compatibility/standard-loader.mjs';
import { prepareUninstall } from '../../scripts/maintenance.mjs';
