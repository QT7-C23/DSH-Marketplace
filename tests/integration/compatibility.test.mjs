...
import { preparePackage, inspectPackage } from '../../src/plugin/compatibility/packages.mjs';
import { assessCompatibility } from '../../src/plugin/compatibility/assessment.mjs';
