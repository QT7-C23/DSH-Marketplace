...
export function downloadFile(resource) {
  ...
  if (resource.sourceId === 'mcp' && resource.serverDefinition) return { filename: `${resource.id}.json`, mime: 'application/json;charset=utf-8', content: JSON.stringify(resource.serverDefinition, null, 2) + '\n' };
