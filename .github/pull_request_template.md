<!-- English / 中文 / 日本語. Complete relevant sections; use N/A with a reason for others. 填写适用部分，不适用请说明。該当箇所を記入し、対象外は理由を記載してください。 -->

## Summary / 变更说明 / 変更内容

<!-- What problem does this solve, and what changes for users? 解决什么问题，用户行为有何变化？解決する問題と利用者への影響を記載。 -->

## Related issues / 关联问题 / 関連 Issue

<!-- Link related issues, or write None / 无 / なし. -->

## Validation / 验证结果 / 検証結果

<!-- Provide npm run verify results, environment, and any failures or untested behavior. 填统一验证结果、环境及失败或未验证部分。検証結果・環境・失敗や未検証の箇所を記載。 -->
...
## Screenshots, if applicable / 截图（如适用）/ 画面（該当時）

<!-- Show visible changes and relevant states; omit private data. 附可见改动及相关状态，删除私人数据。変更した画面と状態を示し、非公開情報は除いてください。 -->

## Review checklist / 提交检查 / 確認事項

- [ ] Changes are focused, and validation results and limitations are stated. / 改动聚焦，已说明验证与限制。/ 変更範囲を絞り、検証と制限を記載した。
- [ ] Required author and license notices are preserved; no credentials or private data are included. / 保留署名与许可，未包含凭据或私人数据。/ 帰属・ライセンスを保持し、機密情報を含めていない。
- [ ] Affected documentation and README translations are updated, or no update is needed. / 已同步相关文档和 README 翻译，或无需更新。/ 関連文書と README 翻訳を更新した、または更新不要。
