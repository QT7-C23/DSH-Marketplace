...
test('Skill bundle validation preserves legacy bundles and accepts only scoped explicit licenses', async () => {
  const { validateSkillBundle } = await import('./skill-bundles.mjs');
