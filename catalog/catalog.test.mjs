...
import { validatePrompt, submissionFile, submissionUrl } from './contracts.mjs';
...
test('curated entries retain the reviewed upstream author and exact original text', async () => {
  const entry = JSON.parse(await readFile(new URL('./prompts/code-reviewer.json', import.meta.url), 'utf8'));
